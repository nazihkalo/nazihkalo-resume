    ...
    <Section noPadding sectionId={SectionId.Hero}>
      <div className="relative flex h-screen w-screen items-center justify-start">
        <div className="max-w-screen-sm px-4 lg:px-0">
          <div className="flex flex-col  items-start gap-y-6 rounded-xl bg-gray-800/40 p-6 text-left shadow-lg backdrop-blur-sm">
      ...
      <div className="relative flex h-screen items-center ml-20 justify-end">
        <Image
            alt={`${name}-image`}
            className="relative flex object-right "
            // layout="fill"
            // objectFit="cover"
            placeholder="blur"
            priority
